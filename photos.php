...
<?php include ('session.php');?>
	...
	<div id="header">
		<div class="head-view">
			<ul>
				<li><a href="home.php" title="Forum"><b>Photos</b></a></li>
				<li></li>
				<li></li>
				<li></li>
				<li></li>
...
<?php
	include("includes/database.php");
			$query=mysqli_query($con,"SELECT * from user where user_id='$id' order by user_id DESC") or die(mysqli_error());
...
<?php
	include("includes/database.php");
			$query=mysqli_query($con,"SELECT * from photos where user_id='$id' ") or die(mysqli_error());
			while($row=mysqli_fetch_array($query)){
				$id = $row['photo_id'];
?>
