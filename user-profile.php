...
?>
	...
	<?php 
	 ...
	 <?php 	if (isset($_GET['user_id'])) {
				...
				$select=mysqli_query($con,"select * from user where user_id='$user_id' ");
	 ...
	 ?>
					...
					<div class="timeline_post_title_area">
									<div class="col-lg-12"><b><?php echo $user_name ?></b></div> 
					</div>
...
if (isset($_GET['user_id'])) {
		$user_id=$_GET['user_id'];
			...
			$get_post=mysqli_query($con,"SELECT * from post where user_id='$user_id' ORDER BY 1 DESC LIMIT 5") or die(mysqli_error());
...
?>				<div class="comment-view-area-wrapper" id="post_list">
						...
						<div class="delete-c"> 
							<a href="delete_profile_comment.php<?php echo '?id='.$comment_id; ?>" title="Delete your comment">
								<button class="btn btn-danger" style="background: #a8c0cc; color: black; font-weight: 700; border:none;font-size: 11px;">Delete</button>
							</a>
						</div>
